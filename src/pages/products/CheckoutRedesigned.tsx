 ...
 * Complete order with shipping address and payment with sidebar navigation
 */
...
import { CreditCard, Smartphone, Building2, Loader2, Lock, Package, Menu } from 'lucide-react';
...
export function CheckoutRedesigned() {
  ...
  const itemsTotal = currencyRound(getCartTotal(cart));
          ...
          <div className="px-4 py-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-600">Complete your order</p>
              </div>
            </div>
          </div>
        </header>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 p-3 bg-cyan-50 rounded-lg flex items-start gap-2 text-sm text-cyan-700">
